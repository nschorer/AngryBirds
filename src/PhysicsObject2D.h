...
public:
	...
	virtual void CollideVisit(Bird_Base&, b2Contact*, const b2ContactImpulse*) { /*DebugMsg::out("GameObject2D hit Bird_Base\n");*/ };
	...
	virtual void CollideVisit(WhiteBirdEgg&, b2Contact*, const b2ContactImpulse*) { /*DebugMsg::out("GameObject2D hit WoodPlatform\n");*/ };

	virtual void CollideVisit(DeathZone&, b2Contact*, const b2ContactImpulse*) { };
};
