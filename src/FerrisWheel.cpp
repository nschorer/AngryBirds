...
FerrisWheel::FerrisWheel(float x, float y, PhysicsWorld* pWorld)
{
	...
	GameObjectMan::Add(pBase, GameObjectName::TowerGroup);

	PhysicsObject2D* pCenter = new WoodCircle(x, y, pWorld);
	pCenter->SetCollisionFlags(0, 0);
	GameObjectMan::Add(pCenter, GameObjectName::TowerGroup);
	...
	GameObjectMan::Add(pSpoke0, GameObjectName::TowerBackground);
	...
	GameObjectMan::Add(pSpoke1, GameObjectName::TowerBackground);
	...
	GameObjectMan::Add(pSpoke2, GameObjectName::TowerBackground);
	...
	GameObjectMan::Add(pSpoke3, GameObjectName::TowerBackground);

	// plats

	PhysicsObject2D* pPlat0 = new WoodPlatShort(x - 150, y, pWorld);
	((Block_Base*)pPlat0)->SetInvincible(true);
	GameObjectMan::Add(pPlat0, GameObjectName::TowerGroup);

	PhysicsObject2D* pPlat1 = new WoodPlatShort(x + 150, y, pWorld);
	((Block_Base*)pPlat1)->SetInvincible(true);
	GameObjectMan::Add(pPlat1, GameObjectName::TowerGroup);

	PhysicsObject2D* pPlat2 = new WoodPlatShort(x, y + 150, pWorld);
	((Block_Base*)pPlat2)->SetInvincible(true);
	GameObjectMan::Add(pPlat2, GameObjectName::TowerGroup);

	PhysicsObject2D* pPlat3 = new WoodPlatShort(x, y - 150, pWorld);
	((Block_Base*)pPlat3)->SetInvincible(true);
	GameObjectMan::Add(pPlat3, GameObjectName::TowerGroup);

	// pigs


	SmallPig* pPig0 = new SmallPig(x - 150, y + 30, pWorld);
	GameObjectMan::Add(pPig0, GameObjectName::Name::TowerGroup);

	SmallPig* pPig1 = new SmallPig(x + 150, y + 30, pWorld);
	GameObjectMan::Add(pPig1, GameObjectName::Name::TowerGroup);

	SmallPig* pPig2 = new SmallPig(x, y + 180, pWorld);
	GameObjectMan::Add(pPig2, GameObjectName::Name::TowerGroup);

	SmallPig* pPig3 = new SmallPig(x, y - 120, pWorld);
	GameObjectMan::Add(pPig3, GameObjectName::Name::TowerGroup);
